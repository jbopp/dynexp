	...
	*/
	...
	public:
		...
		*/
		...
		virtual DynExp::Units::UnitType GetValueUnit() const noexcept override { return DynExp::Units::UnitType::Counts; }
		...
		*/
		///@{
		virtual void ResetStreamSize(DynExp::TaskBase::CallbackType CallbackFunc = nullptr) const override { MakeAndEnqueueTask<TimeTaggerTasks::ResetBufferSizeTask>(std::move(CallbackFunc)); }
