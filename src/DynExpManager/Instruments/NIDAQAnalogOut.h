...
namespace DynExpInstr
{
	...
	public:
		...
		virtual void WriteData(DynExp::TaskBase::CallbackType CallbackFunc) const override { MakeAndEnqueueTask<NIDAQAnalogOutTasks::WriteTask>(std::move(CallbackFunc)); }
		virtual void ClearData(DynExp::TaskBase::CallbackType CallbackFunc = nullptr) const override { MakeAndEnqueueTask<NIDAQAnalogOutTasks::ClearTask>(std::move(CallbackFunc)); }
		virtual void Start(DynExp::TaskBase::CallbackType CallbackFunc = nullptr) const override { MakeAndEnqueueTask<NIDAQAnalogOutTasks::StartTask>(std::move(CallbackFunc)); }
		virtual void Stop(DynExp::TaskBase::CallbackType CallbackFunc = nullptr) const override { MakeAndEnqueueTask<NIDAQAnalogOutTasks::StopTask>(std::move(CallbackFunc)); }
		virtual void Restart(DynExp::TaskBase::CallbackType CallbackFunc = nullptr) const override { MakeAndEnqueueTask<NIDAQAnalogOutTasks::RestartTask>(std::move(CallbackFunc)); }
