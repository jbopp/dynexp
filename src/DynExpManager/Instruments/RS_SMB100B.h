...
namespace DynExpInstr
{
	...
	public:
		...
		virtual DynExp::Units::UnitType GetValueUnit() const noexcept override { return DynExp::Units::UnitType::Power_dBm; }
		virtual bool IsPhaseAdjustable() const noexcept override { return false; }

		// Tasks
		virtual void Start(DynExp::TaskBase::CallbackType CallbackFunc = nullptr) const override { MakeAndEnqueueTask<RS_SMB100BTasks::StartTask>(std::move(CallbackFunc)); }
		virtual void Stop(DynExp::TaskBase::CallbackType CallbackFunc = nullptr) const override { MakeAndEnqueueTask<RS_SMB100BTasks::StopTask>(std::move(CallbackFunc)); }
