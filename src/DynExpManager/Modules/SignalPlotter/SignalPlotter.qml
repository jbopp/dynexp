    ...
    Item {
        ...
        QDynExpMenu {
            ...
            Action {
                ...
                onTriggered: backend.clearStream()
            }
            MenuSeparator {  
            }
            Action {
                id: miPlotRollingView
                text: qsTr("&Rolling view")
                checkable: true
                checked: false
                onTriggered: backend.rollingViewChanged(checked)
            }
            Action {
                id: miPlotAutoscale
                ...
                checkable: true
                checked: true
                onTriggered: backend.autoscaleChanged(checked)
            }
        }
    }
