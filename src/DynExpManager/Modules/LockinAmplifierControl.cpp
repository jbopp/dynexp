...
{
	LockinAmplifierControlWidget::LockinAmplifierControlWidget(LockinAmplifierControl& Owner, QModuleWidget* parent)
		: QModuleWidget(Owner, parent),
		ui(std::make_unique<Ui::LockinAmplifierControl>())
	{
		ui->setupUi(this);
	}
